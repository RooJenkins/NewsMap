...
const ALL_COUNTRIES = [
  // Already done: Argentina, Bolivia, Brazil, Canada, Chile, Colombia, Costa Rica, Cuba, Dominican Republic, Ecuador
  
  // Remaining Americas (12)
  ...
  { name: 'Laos', lat: 19.8563, lng: 102.9955 },
...
console.log(`Total remaining countries: ${ALL_COUNTRIES.length}`);
console.log('Countries by region:');
console.log('  Americas: 12');
console.log('  Europe: 31');
console.log('  Asia-Pacific: 43');
console.log('  Africa: 18');
console.log('  TOTAL: 104 remaining + 10 done = 114 total');
