...
// Batch 10: Countries 135-143 for human rights category
const countries = [
...
async function main() {
  console.log('🚀 Starting human rights summary generation (Batch 10/10 - FINAL BATCH)\n')
  ...
  console.log('\n' + '='.repeat(80))
  console.log('🎉 BATCH 10 COMPLETE - ALL HUMAN RIGHTS SUMMARIES DONE!')
  console.log('='.repeat(80))
