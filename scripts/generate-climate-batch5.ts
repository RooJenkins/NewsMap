...
// Batch 5: Ireland, Israel, Italy, Japan, Jordan, Kazakhstan, Kenya, Kuwait, Laos, Latvia, Lebanon, Libya, Lithuania
const LOCATIONS = [
  { name: 'Ireland', type: 'country' as const, lat: 53.4129, lng: -8.2439, country: 'Ireland' },
  { name: 'Israel', type: 'country' as const, lat: 31.0461, lng: 34.8516, country: 'Israel' },
  { name: 'Italy', type: 'country' as const, lat: 41.8719, lng: 12.5674, country: 'Italy' },
  { name: 'Japan', type: 'country' as const, lat: 36.2048, lng: 138.2529, country: 'Japan' },
  { name: 'Jordan', type: 'country' as const, lat: 30.5852, lng: 36.2384, country: 'Jordan' },
  { name: 'Kazakhstan', type: 'country' as const, lat: 48.0196, lng: 66.9237, country: 'Kazakhstan' },
  { name: 'Kenya', type: 'country' as const, lat: -0.0236, lng: 37.9062, country: 'Kenya' },
  { name: 'Kuwait', type: 'country' as const, lat: 29.3117, lng: 47.4818, country: 'Kuwait' },
  { name: 'Laos', type: 'country' as const, lat: 19.8563, lng: 102.4955, country: 'Laos' },
  { name: 'Latvia', type: 'country' as const, lat: 56.8796, lng: 24.6032, country: 'Latvia' },
  { name: 'Lebanon', type: 'country' as const, lat: 33.8547, lng: 35.8623, country: 'Lebanon' },
  { name: 'Libya', type: 'country' as const, lat: 26.3351, lng: 17.2283, country: 'Libya' },
  { name: 'Lithuania', type: 'country' as const, lat: 55.1694, lng: 23.8813, country: 'Lithuania' },
]
...
async function generateClimateSummaries() {
  ...
  console.log('Generating CLIMATE & ENVIRONMENT write-ups - BATCH 5 (13 countries)')
  console.log('═'.repeat(80))
  console.log()
  ...
  console.log(`\n\n${'═'.repeat(80)}`)
  console.log(`CLIMATE & ENVIRONMENT BATCH 5 COMPLETE`)
  console.log('═'.repeat(80))
  ...
  if (generated === 13) {
    console.log(`\n✅ SUCCESS! All 13 countries in Batch 5 completed!`)
  } else {
    console.log(`\n⚠️  WARNING: Only ${generated}/13 countries completed`)
  }
}
