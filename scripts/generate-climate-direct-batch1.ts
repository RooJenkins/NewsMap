...
const ALL_COUNTRIES = Object.keys(countryData).sort()
...
// This script is a template - it will be populated with actual writeups
// For now, it creates a structure to insert climate writeups in batches

async function main() {
  console.log(`Found ${ALL_COUNTRIES.length} countries total`)
  console.log('Please use Claude Code to generate writeups for these countries...')
  console.log('Countries:', ALL_COUNTRIES.join(', '))
}
