...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var _i, politicsData_1, data, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('🏛️  Starting Politics summaries insertion (Batch 4)');
                    console.log("\uD83D\uDCCA Countries: ".concat(politicsData.length));
                    console.log('='.repeat(80));
                    _i = 0, politicsData_1 = politicsData;
                    _a.label = 1;
                case 1:
                    if (!(_i < politicsData_1.length)) return [3 /*break*/, 6];
                    data = politicsData_1[_i];
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    console.log("\n\uD83D\uDCCD Processing: ".concat(data.name));
                    return [4 /*yield*/, prisma.locationSummary.upsert({
                            where: {
                                name_type_category: {
                                    name: data.name,
                                    type: 'country',
                ...
                case 3:
                    _a.sent();
                    console.log("\u2705 Saved ".concat(data.name, " - ").concat(data.summary.length, " characters"));
                    return [3 /*break*/, 5];
                case 4:
                    error_1 = _a.sent();
                    console.error("\u274C Error saving ".concat(data.name, ":"), error_1);
                    return [3 /*break*/, 5];
                case 5:
                    _i++;
                    return [3 /*break*/, 1];
                case 6:
                    ...
                    console.log("\uD83D\uDCCA Processed ".concat(politicsData.length, " countries"));
                    return [2 /*return*/];
            }
        });
    });
