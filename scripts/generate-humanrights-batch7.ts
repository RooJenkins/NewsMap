...
// Batch 7: Countries 90-104 for human rights category
const countries = [
...
async function main() {
  console.log('🚀 Starting human rights summary generation (Batch 7/10)\n')
  console.log(`Processing ${countries.length} countries (90-104)...\n`)
