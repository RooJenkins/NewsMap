...
// Batch 9: Countries 120-134 for human rights category
const countries = [
...
async function main() {
  console.log('🚀 Starting human rights summary generation (Batch 9/10)\n')
  console.log(`Processing ${countries.length} countries (120-134)...\n`)
