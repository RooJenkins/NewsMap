...
export const CATEGORY_VOICES = {
  politics: {
    name: 'Politics',
    legend: 'Rory Stewart from The Rest is Politics',
    characteristics: [
    ...
    opening: 'Start with a recent event/meeting/decision, then zoom out',
  ...
  economy: {
    ...
    legend: 'Matt Levine from Bloomberg Money Stuff',
    characteristics: [
    ...
    opening: 'Lead with the most absurd/ironic business development',
...
// Save a country summary to database
export async function saveCountrySummary(
...
// Check if a country summary exists
