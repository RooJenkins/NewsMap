...
async function checkProgress() {
  ...
  console.log('========================================')
  console.log('Crime & Justice Writeups - Status Check')
  console.log('========================================')
  console.log(`Total countries: ${ALL_COUNTRIES.length}`)
  console.log(`Already generated: ${existing.length}`)
  console.log(`Remaining: ${ALL_COUNTRIES.length - existing.length}`)
  console.log('========================================\n')
  ...
  const remaining = ALL_COUNTRIES.filter(c => !existingNames.has(c.name))
